    ...
    <div>
        <AppBar sx={{backgroundColor: '#222222'}}>
            <Toolbar className="nav">
                ...
                <div className='rside'>
                    <Link to="/form">
                        <Button variant='contained' sx={{backgroundColor: '#222222', '&:hover':{backgroundColor: 'white', color: '#222222'}}}>Blog Form</Button>
                    </Link>
                    &nbsp;
                    <Link to="/dashboard">
                        <Button variant='contained' sx={{backgroundColor: '#222222', '&:hover':{backgroundColor: 'white', color: '#222222'}}}>Dashboard</Button>
                    </Link>
                </div>
            </Toolbar>
        </AppBar>
