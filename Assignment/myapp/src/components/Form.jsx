...
const Form = () => {
  ...
  return (
    <div className='centreform'>
        <br /><br /><br />
        <Paper elevation={3} sx={{width: 450, height: 440}}>
            <br />
            <div className='head'>
                <h2>BLOG FORM</h2>
            </div>
            ...
            <div className='content'>
                ...
                <br /><br /><br />
                <Link to="/dashboard">
                    <Button variant='contained' onClick={event} sx={{backgroundColor: '#2f2f2f', width: '200px', '&:hover':{transform: 'scale(1.05)'}}}>Upload</Button>
                </Link>
            </div>
        </Paper>
    </div>
